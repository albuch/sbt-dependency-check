...
| Setting                                        | Description                                                                                                | Default Value                                                                       |
|:-----------------------------------------------|:-----------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------|
| dependencyCheckNvdApiKey                       | The API Key to access the NVD API; obtained from https://nvd.nist.gov/developers/request-an-api-key.       |                                                                                     |
| dependencyCheckNvdApiDelay                     | The delay between requests for the NVD API.                                                                |                                                                                     |
| dependencyCheckNvdApiMaxRetryCount             | The maximum number of retry requests for a single call to the NVD API.                                     |                                                                                     |
| dependencyCheckNvdApiValidForHours             | The number of hours to wait before checking for new updates from the NVD.                                  |                                                                                     |
